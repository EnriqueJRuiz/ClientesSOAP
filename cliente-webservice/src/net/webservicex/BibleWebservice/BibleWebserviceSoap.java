...
public interface BibleWebserviceSoap {
    ...
    @RequestWrapper(localName = "GetBibleWordsByChapterAndVerse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsByChapterAndVerse")
    @ResponseWrapper(localName = "GetBibleWordsByChapterAndVerseResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsByChapterAndVerseResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsbyKeyWord", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsbyKeyWord")
    @ResponseWrapper(localName = "GetBibleWordsbyKeyWordResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsbyKeyWordResponse")
    ...
    @RequestWrapper(localName = "GetBookTitles", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBookTitles")
    @ResponseWrapper(localName = "GetBookTitlesResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBookTitlesResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsByBookTitleAndChapter", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsByBookTitleAndChapter")
    @ResponseWrapper(localName = "GetBibleWordsByBookTitleAndChapterResponse", targetNamespace = "http://www.webserviceX.NET", className = "net.webservicex.BibleWebservice.GetBibleWordsByBookTitleAndChapterResponse")
